...
Accessible à **niveau 50**, rang **B minimum**, dans la **Salle d'Ascension** (recherche obligatoire). Voir [content.md](content.md) §2 pour les 12 classes avancées et leurs armes.
...
Voir [content.md](content.md) §1 pour les tableaux complets. Résumé :
...
Les classes avancées peuvent avoir des armes supplémentaires (lance, marteau, orbe, shuriken — voir [content.md](content.md) §2).
...
> **Non implémenté** — données de design définitives. Voir [lore.md](lore.md) §3 pour le contexte des factions.
...
**Fermentation** (stub — non implémenté) :
