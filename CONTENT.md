...
> Fichiers associés : [`readme.md`](readme.md) — doc technique | [`GDD.md`](GDD.md) — formules de jeu
...
> **Compétences des classes avancées** : À compléter.
...
### 12.4 Préparations Fermentées (Stub — non implémenté)
...
| Mannequin | Décoration | — or | Armurier agile |
