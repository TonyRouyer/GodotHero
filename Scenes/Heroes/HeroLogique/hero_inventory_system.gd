...
@onready var equipement_container = $"../CanvasLayer/HeroPanelInfo/HBoxContainer/StatsWindow/VBoxContainer/ContentContainer/VBoxContainer/HeroEquipementUi/HeroEquipementUi"
@onready var global_inventory_node = $"../CanvasLayer/HeroPanelInfo/HBoxContainer/GlobalInventory"
