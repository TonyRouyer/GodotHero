...
func rotate_item(side):
	...
	match side:
		"front":
			...
			%SpriteUnder.position = Vector2(16,0)
			
			%SpriteUpper.set_region_rect(Rect2(32,0,32,32))
			%SpriteUpper.flip_h = true
			%SpriteUpper.position = Vector2(16,0)
			#Placement du marker
			$Marker2D.position = Vector2(32,8)
		"right_side":
			...
			%SpriteUpper.set_region_rect(Rect2(0,0,16,32))
