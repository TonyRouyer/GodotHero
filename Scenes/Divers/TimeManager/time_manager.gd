...
@onready var day_timer : Timer = $Timer
@onready var animation_player : AnimationPlayer = $AnimationPlayer
@onready var jour_label : Label = $mask/jourLabel
@onready var heure_label : Label = $mask/HeureLabel
@onready var selecteur : Sprite2D = $mask/Selecteur
@export var hours_per_day : int = 24
@export var seconds_per_hour : int = 5
var day_length_seconds : int = hours_per_day * seconds_per_hour  # Un jour complet en secondes
...
func play_continuous_animation() -> void:
	if is_daytime:
